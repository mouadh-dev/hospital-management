...
class PharmacienProfilUpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view= inflater.inflate(R.layout.fragment_pharmacien_profil_update, container, false)
        initView(view)
        return  view
    }

    private fun initView(view: View) {
        firstNameProfilPharmacienET = view.findViewById(R.id.FirstNameProfilPharmacien)
        secondNameProfilPharmacienET = view.findViewById(R.id.SecondNameProfilPharmacien)
        ...
        telephoneProfilPharmacienET!!.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                if (telephoneProfilPharmacienET!!.length() < 8 || telephoneProfilPharmacienET!!.length() > 8) {
                    ...
                    saveProfilPharmacienButton!!.error = "le numero n'existe pas"
                } else {
            ...
            if (isLocationEnabled(requireContext())) {
                ...
                fusedLocationProviderClient.lastLocation.addOnCompleteListener { task ->
                    ...
                    if (location == null) {
                        ...
                        adresseProfilPharmacienET!!.setText(getCityName(location.latitude, location.longitude))
                    }
                }
            } else {
                Toast.makeText(
