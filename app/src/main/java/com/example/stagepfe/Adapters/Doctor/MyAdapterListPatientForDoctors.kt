...
class MyAdapterListPatientForDoctors(var mCtx: Context, var resources:Int, var items:List<ModelPatientList>): ArrayAdapter<ModelPatientList>(mCtx, resources, items)  {
